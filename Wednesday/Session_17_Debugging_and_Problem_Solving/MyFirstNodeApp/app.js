...
http.createServer(function (req, res) {
    ...
    fs.readFile("data.json", "UTF-8", functions (err, data) {
            ...
            if (err) {
                ...
                res.end('The location of ' + contentObject.descriptions+ ' is located at ' + '(' + contentObject.properties.longitude + ', ' + contentObject.properties.latitude + ')');  
            }
        }
    );
}).listen(port);
